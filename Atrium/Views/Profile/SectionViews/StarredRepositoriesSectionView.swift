//
//  StarredRepositoriesSectionView.swift
//  Atrium
//
...
class StarredRepositoriesSectionView: UIView, SectionViewDelegate {
    ...
    func addHeaderView() {
        headerView = ProfileSectionHeaderView(title: "Starred repositories")
